...
- `.Codex/skills/research-session/CONVENTIONS.md` — research-session layout and active-session protocol.
- `.Codex/skills/setup-task/instructions/task_package_layout.md` — the file-by-file structure of a `causalab/tasks/<name>/` package and the conventions every task must follow.
...
**Use the `document-issues` skill throughout this workflow.** Issues are written to `${SESSION_DIR}/issues.md` (top level — see `.Codex/skills/research-session/CONVENTIONS.md`).
...
#### 3.1 config.py
- Read template: `.Codex/skills/setup-task/templates/config.py`
- Create the file with constants from the specification

#### 3.2 templates.py
- Read template: `.Codex/skills/setup-task/templates/templates.py`
- Always create this file, even for single-template tasks

#### 3.3 causal_models.py
- Read template: `.Codex/skills/setup-task/templates/causal_models.py`
- Create with variables and mechanisms from specification

#### 3.4 counterfactuals.py
- Read template: `.Codex/skills/setup-task/templates/counterfactuals.py`
- Create counterfactual generators from specification

#### 3.5 token_positions.py
- Read template: `.Codex/skills/setup-task/templates/token_positions.py`
- Create token position definitions from specification

#### 3.6 checker.py
- Read template: `.Codex/skills/setup-task/templates/checker.py`
...
#### 3.7 metrics.py
- Read template: `.Codex/skills/setup-task/templates/metrics.py`
- Create metrics functions

#### 3.8 __init__.py
- Read template: `.Codex/skills/setup-task/templates/__init__.py`
...
## Restrictions
- ONLY read templates from `.Codex/skills/setup-task/templates/`
