...
- **Research-session conventions** (session dir layout, active-session protocol) → [`.Codex/skills/research-session/CONVENTIONS.md`](.Codex/skills/research-session/CONVENTIONS.md).
- **Per-skill behavior** → `.Codex/skills/<name>/SKILL.md`.
