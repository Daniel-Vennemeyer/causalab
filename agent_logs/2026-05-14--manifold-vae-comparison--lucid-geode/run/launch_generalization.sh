...
# Phase 2: 2-D graph_walk. NOTE: run these with BATCH=4 PATH_STEPS=20 (long ICLR
# random-walk prompts OOM at larger 8B batches; baseline+subspace batches are set
# small in the spline runner configs; graph_walk convention is 20 steps).
